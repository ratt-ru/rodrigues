...
class Form(BetterForm):
    ...
    # observation setup
    ms_obslength = FloatField(label='obslength time', initial=0.25,
                              help_text='in hours')
    ...
    gjones_phase_error_model = ChoiceField(label='phase error model',required=False,choices=ERROR_MODELS,initial='SineError')
    ...
    gjones_gain_min_period = FloatField(label='gain min period',required=False,initial=4)
    gjones_gain_max_period = FloatField(label='gain max period',required=False,initial=300)
    gjones_phase_maxerr = FloatField(label='phase maxerr',required=False,initial=10)
    gjones_phase_min_period = FloatField(label='phase min period',required=False,initial=10)
    gjones_phase_max_period = FloatField(label='phase max period',required=False,initial=300)
    gjones_gain_min0 = FloatField(label='gain min0',required=False,initial=0)
    gjones_gain_max0 = FloatField(label='gain max0',required=False,initial=0)
    gjones_gain_max1 = FloatField(label='gain max1',required=False,initial=0)
    gjones_gain_max2 = FloatField(label='gain max2',required=False,initial=0)
    gjones_gain_max3 = FloatField(label='gain max3',required=False,initial=0)
    gjones_gain_scale = FloatField(label='gain scale',required=False,initial=0)
    gjones_gain_offset = FloatField(label='gain offset',required=False,initial=0)
    gjones_phase_min0 = FloatField(label='phase min0',required=False,initial=0)
    gjones_phase_max0 = FloatField(label='phase max0',required=False,initial=0)
    gjones_phase_max1 = FloatField(label='phase max1',required=False,initial=0)
    gjones_phase_max2 = FloatField(label='phase max2',required=False,initial=0)
    gjones_phase_max3 = FloatField(label='phase max3',required=False,initial=0)
    gjones_phase_scale = FloatField(label='phase scale',required=False,initial=0)
    ...
    ejones_pe_m_error_model = ChoiceField(label='pe m error model',required=False,choices=ERROR_MODELS,initial='SineError')


    ejones_pe_l_maxerr = FloatField(label='pe l maxerr',required=False,initial=10)
    ejones_pe_l_min_period = FloatField(label='pe l min period',required=False,initial=10)
    ejones_pe_l_max_period = FloatField(label='pe l max period',required=False,initial=300)
    ejones_pe_m_maxerr = FloatField(label='pe m maxerr',required=False,initial=10)
    ejones_pe_m_min_period = FloatField(label='pe m min period',required=False,initial=10)
    ejones_pe_m_max_period = FloatField(label='pe m max period',required=False,initial=300)

    ejones_pe_l_min0 = FloatField(label='pe l min0',required=False,initial=0)
    ejones_pe_l_max0 = FloatField(label='pe l max0',required=False,initial=0)
    ejones_pe_l_max1 = FloatField(label='pe l max1',required=False,initial=0)
    ejones_pe_l_max2 = FloatField(label='pe l max2',required=False,initial=0)
    ejones_pe_l_max3 = FloatField(label='pe l max3',required=False,initial=0)
    ejones_pe_l_offset = FloatField(label='pe l offset',required=False,initial=0)
    ejones_pe_l_scale = FloatField(label='pe l scale',required=False,initial=0)
    ejones_pe_m_min0 = FloatField(label='pe m min0',required=False,initial=0)
    ejones_pe_m_max0 = FloatField(label='pe m max0',required=False,initial=0)
    ejones_pe_m_max1 = FloatField(label='pe m max1',required=False,initial=0)
    ejones_pe_m_max2 = FloatField(label='pe m max2',required=False,initial=0)
    ejones_pe_m_max3 = FloatField(label='pe m max3',required=False,initial=0)
    ejones_pe_m_offset = FloatField(label='pe m offset',required=False,initial=0)
    ejones_pe_m_scale = FloatField(label='pe m scale',required=False,initial=0)
    ejones_pe_l_offset = FloatField(label='pe l offset',required=False,initial=0)
    ejones_pe_m_offset = FloatField(label='pe m offset',required=False,initial=0)

#ISM scattering gaussian
    ismscatter=BooleanField(initial=True, required=False)
    ...
    im_npix = IntegerField(label='Image size', required=False,help_text='in pixels (default is input image size)')
    im_cellsize = FloatField(label='Pixel size', required=False,help_text='in micro arcseconds (default is input pixel size)')
